...
const platformIcons: Record<Platform, React.ReactNode> = {
  github: (
    <Github className="size-8 transition-all duration-500 ease-out group-hover/card:rotate-20 group-hover/card:scale-110 md:size-10 lg:size-12" />
  ),
  linkedin: (
  ...
  instagram: (
    <Instagram className="size-8 transition-all duration-500 ease-out group-hover/card:rotate-45 group-hover/card:scale-110 md:size-10 lg:size-12" />
  ),
  youtube: (
  ...
  twitch: (
    <Radio className="size-8 transition-all duration-500 ease-out group-hover/card:rotate-360 group-hover/card:scale-110 md:size-10 lg:size-12" />
  ),
  portfolio: (
    <Flame className="size-8 transition-all duration-500 ease-out group-hover/card:-rotate-12 group-hover/card:scale-125 group-hover/card:text-orange-500 md:size-10 lg:size-12" />
  ),
};
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <CloudSnow className="absolute -right-16 -top-16 size-40 rotate-12 text-[#f0f4ff] transition-all duration-700 group-hover:rotate-30 group-hover:scale-110 group-hover:text-[#e5e9ff]" />
        <Share2 className="absolute -bottom-12 -left-12 size-32 -rotate-12 text-[#f0f4ff] transition-all duration-700 group-hover:-rotate-30 group-hover:scale-110 group-hover:text-[#e5e9ff]" />
      ...
      <div className="mb-8 flex items-center gap-3">
        <div className="rounded-full bg-linear-to-br from-primary/10 to-info/10 p-2">
          <Snowflake
            strokeWidth={2.5}
