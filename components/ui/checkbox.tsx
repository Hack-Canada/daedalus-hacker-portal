...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    >
      <Heart className="size-3 fill-primary/50 md:size-4" />
    </CheckboxPrimitive.Indicator>
  </CheckboxPrimitive.Root>
));
